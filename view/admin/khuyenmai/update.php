                ...
                <div class="col-md-12">
                    ...
                    <div class="card ">
                        <div class="card-header">
                            <h3 class="card-title">Cập Nhật KHUYẾN MÃI</small></h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="id_sp"
                                        placeholder="nhập vào id sản phẩm..." value="<?= $id_sp ?>">
                                </div>
                                <div class="form-group">
                                    <label>Mã Khuyến Mãi </label> <br>
                                    <input type="text" class="form-control" name="ma_km"
                                        placeholder="nhập vào mã khuyến mãi..." value="<?= $ma_km ?>">
                                </div>
                                <div class="form-group">
                                    <label>Phần Trăm Khuyến Mãi </label> <br>
                                    <input type="text" class="form-control" name="pt_km"
                                        placeholder="nhập vào phần trăm khuyến mãi..." value="<?= $pt_km ?>">
                                </div>
                                <div class="form-group">
                                    <label>Ngày Bắt Đầu</label> <br>
                                    <input type="datetime-local" class="form-control" name="ngay_bd"
                                        placeholder="nhập ngày bắt đầu khuyến mãi..." value="<?= $ngay_bd ?>">
                                </div>
                                <div class="form-group">
                                    <label>Ngày Kết Thúc</label> <br>
                                    <input type="datetime-local" class="form-control" name="ngay_kt"
                                        placeholder="nhập ngày kết thúc khuyến mãi..." value="<?= $ngay_kt ?>">
                                </div>
                                <div class="form-group">
                                    <form>
                                ...
                                <div class="row mb10 ">
                                    <input type="hidden" name="id_km" value="<?php if (isset($id_km) && ($id_km > 0))
                                        echo $id_km; ?>">
                                    <input class="mr20" type="submit" name="capnhat" value="CẬP NHẬT">
                                    <input class="mr20" type="reset" value="NHẬP LẠI">
                                    <a href="index.php?act=listkm"><input class="mr20" type="button"
                                            value="DANH SÁCH"></a>
                                </div>
                                <?php
